		...
		return $(this).each(function(){
			...
			$(this).bind('load', function(){
				...
				if(image.attr(settings.imageAttr).length > 0 || !settings.requireText){
					...
					var div = $(this).parent().append("<" + settings.captionElement + " class='" + settings.captionClass + "'>" + image.attr(settings.imageAttr) + '</' + settings.captionElement + '>');
