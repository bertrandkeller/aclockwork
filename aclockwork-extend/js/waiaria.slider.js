...
var TT = {
        ...
        update:function(e) {
                ...
                TT.tooltip.style.left = Math.round((curleft - ((24 - osw) / 2))) + "px";
                TT.tooltip.style.top = (curtop + 9)  + "px";
                ...
                $(".number_solution").empty().append($('select option:selected').html());
                function displayVals() {
                      var number = $('select option:selected').val();
                      var newVal = number * Math.round(Math.log(40));
                      $(".price_number span").html(newVal);
                    }
